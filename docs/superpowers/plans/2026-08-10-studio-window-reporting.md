...
- [ ] `grep -rn "for the next 4 weeks" src/` — must return nothing. The phrase is deliberately absent (spec §2) and is the most likely thing for a well-meaning implementer to have added back.
