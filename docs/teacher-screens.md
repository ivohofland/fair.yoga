...
- An invitee or new person can be added only once the class is about to start; someone with no student profile yet is booked at the default tier, anyone else at their own
