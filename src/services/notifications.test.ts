  ...
  beforeAll(async () => {
    const teacher = await prisma.teacher.create({
      data: {
        ...
        account: { create: { email: `notify-teacher-${uniqueSuffix}@test.local` } },
  ...
  beforeAll(async () => {
    const teacher = await prisma.teacher.create({
      data: {
        ...
        account: { create: { email: `bulk-notify-teacher-${uniqueSuffix}@test.local` } },
  ...
  beforeAll(async () => {
    const teacher = await prisma.teacher.create({
      data: {
        ...
        account: { create: { email: `read-notify-teacher-${uniqueSuffix}@test.local` } },
  ...
  beforeAll(async () => {
    const teacher = await prisma.teacher.create({
      data: {
        ...
        account: { create: { email: `email-fallback-teacher-${uniqueSuffix}@test.local` } },
