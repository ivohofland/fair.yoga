...
- **A template is a stamp, not a live link** (#194): editing one changes nothing that already exists — not the day, time, room, rates or capacity of any generated class, ever. The edit answers with the first week the new schedule can reach; the hourly sweep is what lays it down. The studio family behaves identically and always did — #284 carries its week-keying
